...
class SampleApp(tk.Tk):
	...
	def add(self):
		for F in ( Watchlist_Window, News_Window, Portfolio_Window, Funds_Window, Profile_Window, History_Window,Orders_Window ):
			page_name = F.__name__
			frame = F(parent=container, controller=self)
			self.frames[page_name] = frame
...
class Load_Window(tk.Frame):
	...
	def __init__(self, parent, controller):
		...
		print(1)
		logoimg = Image.open(r"img/logo.png")
...
class Watchlist_Window(tk.Frame):
	...
	def __init__(self, parent, controller):
		...
		img = Image.open("img/profile14.png")
		img = img.resize((60,60),Image.ANTIALIAS)

		self.photoImg =  ImageTk.PhotoImage(img)

		img1 = Image.open("img/profileicon2.png")
		img1 = img1.resize((35,35),Image.ANTIALIAS)

		self.profile =  ImageTk.PhotoImage(img1)

		img2 = Image.open("img/fund.png")
...
#
		...
		logoimg1 = Image.open('img/Search.png')
		...
		def clickAbout():
			...
			winbtn0 = ImageTk.PhotoImage(file="img/market.png")
			winbtn1 = ImageTk.PhotoImage(file="img/limit.png")
			...
			while 1:
				try:
					with concurrent.futures.ThreadPoolExecutor() as executor:
						...
						return_value = executor.submit(update_continous, symbol1).result()
						print(return_value)
...
class Funds_Window(tk.Frame):
	...
	def __init__(self, parent, controller):
		...
		logoimg1 = Image.open(r"img/logo.png")
		...
		img2 = Image.open(r"img\fund.png")
		img2 = img2.resize((30,30),Image.ANTIALIAS)
		...
		img3 = Image.open(r"img\theme2.png")
		img3 = img3.resize((30,30),Image.ANTIALIAS)

		self.theme2 =  ImageTk.PhotoImage(img3)


		img4 = Image.open(r"img\logout2.png")
		img4 = img4.resize((30,30),Image.ANTIALIAS)
...
#
		...
		umargin1label = tk.Label(self,text="₹" +str(tot),font=("Arial",15),bg="black",fg="red")
...
class Portfolio_Window(tk.Frame):
	...
	def __init__(self,parent,controller):
		...
		if len(port_table)>0:
			...
			global tot
			tot = 0
			for i in range(len(port_table)):
				tot = tot + port_table[i][4]
		print(tot)
		canvas.pack(side="left", fill="both", expand=True)
		scrollbar.pack(side="right", fill="y")
...
#
		...
		refimg = Image.open(r"img/reload.png")
...
class History_Window(tk.Frame):
	...
	def __init__(self, parent, controller):
		...
		img = Image.open(r"img/profile14.png")
		img = img.resize((60,60),Image.ANTIALIAS)

		self.photoImg =  ImageTk.PhotoImage(img)

		img1 = Image.open(r"img/profileicon2.png")
		img1 = img1.resize((35,35),Image.ANTIALIAS)
		...
		img3 = Image.open(r"img/theme2.png")
		img3 = img3.resize((30,30),Image.ANTIALIAS)
